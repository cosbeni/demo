...
public class UserClientDS extends DataSource {

  private DemoConstants demoConstants;

  private static UserClientDS instance = null;

  public static UserClientDS getInstance() {
    if (instance == null) {
      instance = new UserClientDS("UserClientDS");
    }
    return instance;
  }

  public UserClientDS(String id) {
