...
@Dependent public class ServerMarshallingFactoryImpl implements MarshallerFactory {
  ...
  private Marshaller<Group> com_cosbeni_demo_shared_entity_Group;
  ...
  private Marshaller<User> com_cosbeni_demo_shared_entity_User;
  ...
  public ServerMarshallingFactoryImpl() {
    ...
    com_cosbeni_demo_shared_entity_Group = new Marshaller<Group>() {
      ...
      public Group demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          if ((obj.containsKey("groupName")) && (!obj.get("groupName").isNull())) {
            entity.setGroupName(java_lang_String.demarshall(obj.get("groupName"), a1));
          }
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.cosbeni.demo.shared.entity.Group", t);
        }
      }
      public String marshall(Group a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.cosbeni.demo.shared.entity.Group\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(512).append("{\"^EncodedType\":\"com.cosbeni.demo.shared.entity.Group\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Long.marshall(a0.getId(), a1)).append(",").append("\"groupName\" : ").append(java_lang_String.marshall(a0.getGroupName(), a1)).append(",").append("\"description\" : ").append(java_lang_String.marshall(a0.getDescription(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.cosbeni.demo.shared.entity.Group", com_cosbeni_demo_shared_entity_Group);
    ...
    com_cosbeni_demo_shared_entity_User = new Marshaller<User>() {
      ...
      public User demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          if ((obj.containsKey("rid")) && (!obj.get("rid").isNull())) {
            entity.setRid(java_lang_Long.demarshall(obj.get("rid"), a1));
          }
          ...
          if ((obj.containsKey("group")) && (!obj.get("group").isNull())) {
            entity.setGroup(com_cosbeni_demo_shared_entity_Group.demarshall(obj.get("group"), a1));
          }
          if ((obj.containsKey("flag")) && (!obj.get("flag").isNull())) {
            entity.setFlag(java_lang_Boolean.demarshall(obj.get("flag"), a1));
          }
          if ((obj.containsKey("command")) && (!obj.get("command").isNull())) {
            entity.setCommand(java_lang_String.demarshall(obj.get("command"), a1));
          }
          return entity;
        } catch (Throwable t) {
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.cosbeni.demo.shared.entity.User", t);
        }
      }
      public String marshall(User a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.cosbeni.demo.shared.entity.User\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(1792).append("{\"^EncodedType\":\"com.cosbeni.demo.shared.entity.User\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Long.marshall(a0.getId(), a1)).append(",").append("\"rid\" : ").append(java_lang_Long.marshall(a0.getRid(), a1)).append(",").append("\"userName\" : ").append(java_lang_String.marshall(a0.getUserName(), a1)).append(",").append("\"password\" : ").append(java_lang_String.marshall(a0.getPassword(), a1)).append(",").append("\"firstName\" : ").append(java_lang_String.marshall(a0.getFirstName(), a1)).append(",").append("\"lastName\" : ").append(java_lang_String.marshall(a0.getLastName(), a1)).append(",").append("\"email\" : ").append(java_lang_String.marshall(a0.getEmail(), a1)).append(",").append("\"group\" : ").append(com_cosbeni_demo_shared_entity_Group.marshall(a0.getGroup(), a1)).append(",").append("\"flag\" : ").append(java_lang_Boolean.marshall(a0.getFlag(), a1)).append(",").append("\"command\" : ").append(java_lang_String.marshall(a0.getCommand(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.cosbeni.demo.shared.entity.User", com_cosbeni_demo_shared_entity_User);
